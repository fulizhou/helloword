...
router.get('/', function(req, res, next) {
    ...
    try{
        ...
        console.log('message_article');
        var params = url.parse(req.url, true).query;

        if(common.descrypt_login(req, res)){
            res.render('message_article_list', {"article_list_count":config.article_list_count,"terminalType":params.terminalType})
        }
        else{
            //res.render('login', { app_title: config.app_title,re_login:1});
        }
        ...
        console.log("错误：/message_layouts：" + e);
    }
...
router.get('/list', function(req, res, next) {
    ...
    try{
        ...
        var params = url.parse(req.url, true).query;
        var article_list = JSON.parse(fs.readFileSync('./service/message_article_list.json'));
        ...
        console.log("错误：/message_layouts/list：" + e);
    }
